...
/**
 * create_buffer - allocated 1024 bytes for a buffer
 * @file: name of file buffer
 *
 * Return: pointer to newly alloc buffer
 */
 ...
 * @argc: number of arguments to the prog
 * @argv: array of pointers to the args
 *
 * Return: 0 on success
 *
 * Description: if arg count incorrect - exit code 9
 * If file_from not exist or cannot be read - exit code 98
 * If file_to cannot be created or written to - exit code 99
 * If file_to or file_from cannjot closed - exit code 100
 */
